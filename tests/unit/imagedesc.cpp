...
TEST_CASE("ImageDesc_fromSdp_JpegXs_420_8bit") {
        ...
        md.addPayloadType(96);
        md.setAttribute("rtpmap", "96 jxsv/90000");
        md.setAttribute("fmtp", "96 sampling=YCbCr-4:2:0;depth=8;width=640;height=480");
        ImageDesc img = ImageDesc::fromSdp(md);
        CHECK(img.isValid());
        CHECK(img.width() == 640);
...
TEST_CASE("ImageDesc_fromSdp_JpegXs_422_12bit") {
        ...
        md.addPayloadType(96);
        md.setAttribute("rtpmap", "96 jxsv/90000");
        md.setAttribute("fmtp", "96 sampling=YCbCr-4:2:2;depth=12;width=3840;height=2160");
        ImageDesc img = ImageDesc::fromSdp(md);
        CHECK(img.isValid());
...
TEST_CASE("ImageDesc_fromSdp_JpegXs_420_10bit") {
        ...
        md.addPayloadType(96);
        md.setAttribute("rtpmap", "96 jxsv/90000");
        md.setAttribute("fmtp", "96 sampling=YCbCr-4:2:0;depth=10;width=1280;height=720");
        ImageDesc img = ImageDesc::fromSdp(md);
        CHECK(img.isValid());
...
TEST_CASE("ImageDesc_fromSdp_JpegXs_420_12bit") {
        ...
        md.addPayloadType(96);
        md.setAttribute("rtpmap", "96 jxsv/90000");
        md.setAttribute("fmtp", "96 sampling=YCbCr-4:2:0;depth=12;width=640;height=480");
        ImageDesc img = ImageDesc::fromSdp(md);
        CHECK(img.isValid());
        CHECK(img.width() == 640);
        CHECK(img.height() == 480);
...
TEST_CASE("ImageDesc_fromSdp_Raw_RGB8") {
        ...
        md.setAttribute("fmtp", "96 sampling=RGB;depth=8;width=1920;height=1080;colorimetry=BT709-2;RANGE=FULL");
        ImageDesc img = ImageDesc::fromSdp(md);
        CHECK(img.isValid());
        CHECK(img.width() == 1920);
        CHECK(img.height() == 1080);
...
TEST_CASE("ImageDesc_fromSdp_Raw_RGBA8") {
        ...
        md.addPayloadType(96);
        md.setAttribute("rtpmap", "96 raw/90000");
        md.setAttribute("fmtp", "96 sampling=RGBA;depth=8;width=1920;height=1080;colorimetry=BT709-2;RANGE=FULL");
        ImageDesc img = ImageDesc::fromSdp(md);
        CHECK(img.isValid());
