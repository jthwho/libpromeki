...
static const unsigned char *encodedBytes(const ObfuscatedString<N, Seed> &obf) {
...
TEST_CASE("ObfuscatedString: implicit conversion") {
        static constexpr auto obf =
            ObfuscatedString<6, 12345>("hello");
        String s = obf;
        CHECK(s == "hello");
}
...
TEST_CASE("ObfuscatedString: different seeds produce different data") {
        static constexpr auto obf1 =
            ObfuscatedString<6, 100>("hello");
        static constexpr auto obf2 =
            ObfuscatedString<6, 200>("hello");
...
TEST_CASE("ObfuscatedString: no plaintext in encoded data") {
        ...
        static constexpr auto obf =
            ObfuscatedString<44, 0xDEADBEEF>("The quick brown fox jumps over the lazy dog");
...
TEST_CASE("ObfuscatedString: repeated plaintext bytes produce distinct encoded bytes") {
        ...
        static constexpr auto obf =
            ObfuscatedString<17, 0x12345678>("aaaaaaaaaaaaaaaa");
        const unsigned char *enc = encodedBytes(obf);
...
TEST_CASE("ObfuscatedString: CBC propagation — one byte change cascades") {
        ...
        static constexpr auto obf1 =
            ObfuscatedString<17, 0xAAAAAAAA>("Abcdefghijklmnop");
        static constexpr auto obf2 =
            ObfuscatedString<17, 0xAAAAAAAA>("Bbcdefghijklmnop");
...
TEST_CASE("ObfuscatedString: avalanche — small input change flips many bits") {
        ...
        static constexpr auto obf1 =
            ObfuscatedString<17, 0xBBBBBBBB>("Abcdefghijklmnop");
        static constexpr auto obf2 =
            ObfuscatedString<17, 0xBBBBBBBB>("Cbcdefghijklmnop");
        const unsigned char *enc1 = encodedBytes(obf1);
        const unsigned char *enc2 = encodedBytes(obf2);
...
TEST_CASE("ObfuscatedString: seed sensitivity — adjacent seeds differ widely") {
        ...
        static constexpr auto obf1 =
            ObfuscatedString<17, 1000>("abcdefghijklmnop");
        static constexpr auto obf2 =
            ObfuscatedString<17, 1001>("abcdefghijklmnop");
        const unsigned char *enc1 = encodedBytes(obf1);
        const unsigned char *enc2 = encodedBytes(obf2);
...
TEST_CASE("ObfuscatedString: encoded byte distribution is roughly uniform") {
        ...
        static constexpr auto obf1 =
            ObfuscatedString<44, 0x1111>("The quick brown fox jumps over the lazy dog");
        static constexpr auto obf2 =
            ObfuscatedString<44, 0x2222>("The quick brown fox jumps over the lazy dog");
        static constexpr auto obf3 =
            ObfuscatedString<44, 0x3333>("The quick brown fox jumps over the lazy dog");
        static constexpr auto obf4 =
            ObfuscatedString<44, 0x4444>("The quick brown fox jumps over the lazy dog");
