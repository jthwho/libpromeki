 ...
 *
 * PixelMemLayout concerns itself only with the mechanical aspects of pixel
 ...
 * color model details.  Those semantics belong to PixelFormat.
 *
 ...
 * @endcode
 *
 * @see PixelFormat, @ref typeregistry "TypeRegistry Pattern"
 */
class PixelMemLayout {
        public:
                ...
                enum ID {
                        ...
                        P_444_3x12_LE = 94, ///< 3 planes, 12-bit in 16-bit LE words, 4:4:4 (ProRes 4444 / XQ decode surface).
                 ...
                 *
                 * After this call, constructing a PixelMemLayout from @p data.id
                ...
                /**
                 * @brief Returns a list of all registered PixelMemLayout IDs.
                 *
                 ...
                 */
                inline PixelMemLayout(ID id = Invalid);
                ...
                bool operator==(const PixelMemLayout &o) const { return d == o.d; }
