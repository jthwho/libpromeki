...
/**
 * @brief Subscriber interface for @ref MjpegStreamMediaIO.
 * @ingroup proav
 *
 * Attach a concrete subscriber to a live @ref MjpegStreamMediaIO
 * via @ref MjpegStreamMediaIO::attachSubscriber and the sink
 ...
 * has been delivered or @ref MjpegStreamMediaIO::detachSubscriber
 * has returned.
 *
 * @par Example
 * @code
...
class MjpegStreamSubscriber {
        public:
                 ...
                 * @ref MjpegStreamMediaIO::detachSubscriber was
...
/**
 * @brief Snapshot of @ref MjpegStreamMediaIO internal counters.
 * @ingroup proav
 *
 * Returned by @ref MjpegStreamMediaIO::snapshot.  Counters
 ...
 * @ingroup proav
 *
 * @c MjpegStreamMediaIO is the transport-agnostic core of the
 ...
 * @ref DedicatedThreadMediaIO; subscriber callbacks fire on that
 * worker.
 */
class MjpegStreamMediaIO : public DedicatedThreadMediaIO {
                PROMEKI_OBJECT(MjpegStreamMediaIO, DedicatedThreadMediaIO)
        public:
                ...
                MjpegStreamMediaIO(ObjectBase *parent = nullptr);
                 ...
                 * @par Example
                 * @code
                 * delete new MjpegStreamMediaIO();   // exits cleanly
                 * @endcode
                 */
                ~MjpegStreamMediaIO() override;
                 ...
                 */
                static HttpHandlerFunc buildMultipartHandler(MjpegStreamMediaIO *sink);
...
/**
 * @brief @ref MediaIOFactory for the MjpegStream backend.
 * @ingroup proav
 */
class MjpegStreamFactory : public MediaIOFactory {
        public:
                MjpegStreamFactory() = default;

                String name() const override { return String("MjpegStream"); }
                String displayName() const override { return String("MJPEG Preview Stream"); }
                String description() const override {
                        return String("Frame-rate-limited motion-JPEG preview sink "
