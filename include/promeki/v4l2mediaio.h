 ...
 * @par Example
 * @code
 * MediaIO::Config cfg = MediaIOFactory::defaultConfig("V4L2");
 ...
 * @ref DedicatedThreadMediaIO; the V4L2 video capture and ALSA audio
 * capture spin their own internal threads on top of that, queueing
 * frames the worker drains in @c executeCmd(Read).
 */
class V4l2MediaIO : public DedicatedThreadMediaIO {
        ...
        public:
                ...
                /** @brief Constructs a V4l2MediaIO. */
...
/**
 * @brief @ref MediaIOFactory for the V4L2 backend.
 * @ingroup proav
 */
