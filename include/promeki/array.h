...
template <typename T, size_t NumValues> class Array {
        public:
                ...
                constexpr Array(Args... args) : d{static_cast<T>(args)...} {}
                 ...
                 */
                constexpr size_t size() const { return d.size(); }
                 ...
                 */
                template <typename U, size_t OtherNumValues> constexpr Array(const Array<U, OtherNumValues> &other) {
                 ...
                 */
                template <typename U> constexpr Array<T, NumValues> &operator=(const Array<U, NumValues> &other) {
                ...
                constexpr Array<T, NumValues> &operator=(const Array<U, OtherNumValues> &other) {
                        static_assert(std::is_assignable_v<T &, U>, "Incompatible types");
                        static_assert(OtherNumValues <= NumValues, "Incompatible sizes");
                        for (size_t i = 0; i < NumValues; ++i) {
                 ...
                 * @return Reference to this array.
                 */
                template <typename U> constexpr Array<T, NumValues> &operator=(U value) {
                        static_assert(std::is_assignable_v<T &, U>, "Incompatible types");
                        for (size_t i = 0; i < NumValues; ++i) {
                 ...
                 */
                constexpr T &operator[](size_t index) { return d[index]; }
                 ...
                 */
                constexpr const T &operator[](size_t index) const { return d[index]; }
                 ...
                 * @return Reference to this array.
                 */
                constexpr Array<T, NumValues> &operator+=(const Array<T, NumValues> &other) {
                 ...
                 * @return Reference to this array.
                 */
                constexpr Array<T, NumValues> &operator+=(const T &scalar) {
                 ...
                 */
                constexpr const T *data() const { return d.data(); }
                 ...
                 */
                constexpr Array<T, NumValues> lerp(const Array<T, NumValues> &other, double v) const {
                 ...
                 */
                constexpr Array<T, NumValues> clamp(const Array<T, NumValues> &min, const Array<T, NumValues> &max) const {
                        Array<T, NumValues> ret;
                 ...
                 */
                constexpr bool isBetween(const Array<T, NumValues> &min, const Array<T, NumValues> &max) const {
                        for (size_t i = 0; i < d.size(); ++i) {
                ...
                friend constexpr Array<T, NumValues> operator+(Array<T, NumValues> lhs, const Array<T, NumValues> &rhs) {
                        lhs += rhs;
                        return lhs;
                }
                ...
                friend constexpr Array<T, NumValues> operator+(Array<T, NumValues> lhs, const T &scalar) {
                        lhs += scalar;
                        return lhs;
                }
                ...
                friend constexpr bool operator==(const Array<T, NumValues> &lhs, const Array<T, NumValues> &rhs) {
                        for (size_t i = 0; i < NumValues; ++i)
                ...
                friend constexpr bool operator>(const Array<T, NumValues> &lhs, const Array<T, NumValues> &rhs) { return rhs < lhs; }

                /** @brief Lexicographic less-or-equal comparison. */
                friend constexpr bool operator<=(const Array<T, NumValues> &lhs, const Array<T, NumValues> &rhs) { return !(rhs < lhs); }

                /** @brief Lexicographic greater-or-equal comparison. */
                friend constexpr bool operator>=(const Array<T, NumValues> &lhs, const Array<T, NumValues> &rhs) { return !(lhs < rhs); }
