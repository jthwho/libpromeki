...
/**
 * @brief MediaIO backend that decodes compressed packets into uncompressed Frames.
 * @ingroup proav
 *
 ...
 */
class VideoDecoderMediaIO : public SharedThreadMediaIO {
                PROMEKI_OBJECT(VideoDecoderMediaIO, SharedThreadMediaIO)
        public:
                ...
                VideoDecoderMediaIO(ObjectBase *parent = nullptr);
                ~VideoDecoderMediaIO() override;
...
/**
 * @brief @ref MediaIOFactory for the VideoDecoder backend.
 * @ingroup proav
 */
class VideoDecoderFactory : public MediaIOFactory {
        public:
                VideoDecoderFactory() = default;

                String name() const override { return String("VideoDecoder"); }
                String displayName() const override { return String("Video Decoder"); }
                String description() const override {
                        return String("Decodes compressed video bitstreams into uncompressed frames");
                }
