...
TuiBoxLayout::TuiBoxLayout(TuiBoxDirection direction, ObjectBase *parent) : TuiLayout(parent), _direction(direction) {}
...
void TuiGridLayout::addWidget(TuiWidget *widget, int row, int col, int rowSpan, int colSpan) {
