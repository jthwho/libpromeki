...
void TuiScrollArea::paintEvent(TuiPaintEvent *) {
        ...
        if(_contentWidget) {
                _contentWidget->setGeometry(Rect2Di32(-_scrollX, -_scrollY,
                        _contentWidget->width(), _contentWidget->height()));
        }
}
...
void TuiScrollArea::keyPressEvent(KeyEvent *e) {
        ...
        switch(e->key()) {
                ...
                case KeyEvent::Key_Left: setScrollX(_scrollX - 1); e->accept(); break;
                case KeyEvent::Key_Right: setScrollX(_scrollX + 1); e->accept(); break;
                case KeyEvent::Key_PageUp: setScrollY(_scrollY - height()); e->accept(); break;
                case KeyEvent::Key_PageDown: setScrollY(_scrollY + height()); e->accept(); break;
                default: break;
        }
}
