...
static size_t interleavedLineStride(const PixelMemLayout::Data *d, size_t /*planeIdx*/,
...
static size_t interleavedPlaneSize(const PixelMemLayout::Data *d, size_t planeIdx,
...
static size_t v210LineStride(const PixelMemLayout::Data * /*d*/, size_t /*planeIdx*/,
                             size_t width, size_t linePad, size_t lineAlign) {
...
static size_t v210PlaneSize(const PixelMemLayout::Data *d, size_t planeIdx,
                            size_t width, size_t height,
                            size_t linePad, size_t lineAlign) {
...
static size_t planarLineStride(const PixelMemLayout::Data *d, size_t planeIdx,
                               size_t width, size_t linePad, size_t lineAlign) {
...
static size_t planarPlaneSize(const PixelMemLayout::Data *d, size_t planeIdx,
                              size_t width, size_t height,
                              size_t linePad, size_t lineAlign) {
        const auto &p = d->planes[planeIdx];
