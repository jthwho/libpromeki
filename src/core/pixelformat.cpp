...
static PixelFormat::Data makeJPEG_YUV8_422_Rec709() {
        return makeJPEG_YUV({
                ...
                PixelMemLayout::I_422_3x8, ColorModel::YCbCr_Rec709,
...
static PixelFormat::Data makeJPEG_YUV8_420_Rec709() {
        return makeJPEG_YUV({
                ...
                PixelMemLayout::P_420_3x8, ColorModel::YCbCr_Rec709,
...
static PixelFormat::Data makeJPEG_YUV8_422_Rec601() {
        return makeJPEG_YUV({
                ...
                PixelMemLayout::I_422_3x8, ColorModel::YCbCr_Rec601,
                /*limited*/ true, /*is420*/ false,
                { PixelFormat::YUV8_422_Rec601,
                  PixelFormat::YUV8_422_UYVY_Rec601 },
                { PixelFormat::YUV8_422_Rec601,
                  PixelFormat::YUV8_422_UYVY_Rec601,
                  PixelFormat::RGB8_sRGB,
                  PixelFormat::RGBA8_sRGB }
...
static PixelFormat::Data makeJPEG_YUV8_420_Rec601() {
        return makeJPEG_YUV({
                ...
                PixelMemLayout::P_420_3x8, ColorModel::YCbCr_Rec601,
                /*limited*/ true, /*is420*/ true,
                { PixelFormat::YUV8_420_Planar_Rec601,
                  PixelFormat::YUV8_420_SemiPlanar_Rec601 },
                { PixelFormat::YUV8_420_Planar_Rec601,
                  PixelFormat::YUV8_420_SemiPlanar_Rec601,
                  PixelFormat::RGB8_sRGB,
                  PixelFormat::RGBA8_sRGB }
...
static PixelFormat::Data makeJPEG_YUV8_422_Rec709_Full() {
        return makeJPEG_YUV({
                PixelFormat::JPEG_YUV8_422_Rec709_Full,
...
static PixelFormat::Data makeJPEG_YUV8_422_Rec601_Full() {
        return makeJPEG_YUV({
                PixelFormat::JPEG_YUV8_422_Rec601_Full,
...
static PixelFormat::Data makeJPEG_XS_YUV8_422_Rec709() {
        return makeJPEG_XS_YUV({
                ...
                PixelMemLayout::P_422_3x8, 8, /*is420*/ false,
                { PixelFormat::YUV8_422_Planar_Rec709 },
                { PixelFormat::YUV8_422_Planar_Rec709 }
        });
}
...
static PixelFormat::Data makeJPEG_XS_YUV10_422_Rec709() {
        return makeJPEG_XS_YUV({
                ...
                PixelMemLayout::P_422_3x10_LE, 10, /*is420*/ false,
...
static PixelFormat::Data makeJPEG_XS_YUV12_422_Rec709() {
        return makeJPEG_XS_YUV({
                ...
                PixelMemLayout::P_422_3x12_LE, 12, /*is420*/ false,
...
static PixelFormat::Data makeJPEG_XS_YUV8_420_Rec709() {
        return makeJPEG_XS_YUV({
                ...
                PixelMemLayout::P_420_3x8, 8, /*is420*/ true,
                { PixelFormat::YUV8_420_Planar_Rec709 },
                { PixelFormat::YUV8_420_Planar_Rec709 }
        });
}
...
static PixelFormat::Data makeJPEG_XS_YUV10_420_Rec709() {
        return makeJPEG_XS_YUV({
                ...
                PixelMemLayout::P_420_3x10_LE, 10, /*is420*/ true,
...
static PixelFormat::Data makeJPEG_XS_YUV12_420_Rec709() {
        return makeJPEG_XS_YUV({
                ...
                PixelMemLayout::P_420_3x12_LE, 12, /*is420*/ true,
...
static const PixelFormat::CompSemantic ycbcrSem8[]  = { {"Luma","Y",16,235}, {"Chroma Blue","Cb",16,240}, {"Chroma Red","Cr",16,240} };
static const PixelFormat::CompSemantic ycbcrSem10[] = { {"Luma","Y",64,940}, {"Chroma Blue","Cb",64,960}, {"Chroma Red","Cr",64,960} };
static const PixelFormat::CompSemantic ycbcrSem12[] = { {"Luma","Y",256,3760}, {"Chroma Blue","Cb",256,3840}, {"Chroma Red","Cr",256,3840} };
static const PixelFormat::CompSemantic ycbcrSem16[] = { {"Luma","Y",4096,60160}, {"Chroma Blue","Cb",4096,61440}, {"Chroma Red","Cr",4096,61440} };
...
// JPEG encode).
static const PixelFormat::CompSemantic ycbcrSem8Full[]  = { {"Luma","Y",0,255}, {"Chroma Blue","Cb",0,255}, {"Chroma Red","Cr",0,255} };

static PixelFormat::Data makeYCbCrDesc(PixelFormat::ID id, const char *name, const char *desc,
...
static PixelFormat::Data makeYUV8_422_Rec709_Full() {
        return makeYCbCrDescWithModel(PixelFormat::YUV8_422_Rec709_Full,
                "YUV8_422_Rec709_Full",
                "8-bit YCbCr 4:2:2 YUYV, Rec.709, full range",
                PixelMemLayout::I_422_3x8, ycbcrSem8Full,
                ColorModel::YCbCr_Rec709);
}

static PixelFormat::Data makeYUV8_422_Rec601_Full() {
        return makeYCbCrDescWithModel(PixelFormat::YUV8_422_Rec601_Full,
...
static PixelFormat::Data makeYUV8_420_Planar_Rec709_Full() {
        return makeYCbCrDescWithModel(PixelFormat::YUV8_420_Planar_Rec709_Full,
                "YUV8_420_Planar_Rec709_Full",
                "8-bit YCbCr 4:2:0 planar, Rec.709, full range",
                PixelMemLayout::P_420_3x8, ycbcrSem8Full,
                ColorModel::YCbCr_Rec709);
}

static PixelFormat::Data makeYUV8_420_Planar_Rec601_Full() {
        return makeYCbCrDescWithModel(PixelFormat::YUV8_420_Planar_Rec601_Full,
...
static PixelFormat::Data makeBGRDesc(PixelFormat::ID id, const char *name, const char *desc,
...
static PixelFormat::Data makeARGBDesc(PixelFormat::ID id, const char *name, const char *desc,
                                    PixelMemLayout::ID pfId, float rangeMax) {
        PixelFormat::Data d;
        d.id              = id;
        d.name            = name;
        d.desc            = desc;
...
static PixelFormat::Data makeABGRDesc(PixelFormat::ID id, const char *name, const char *desc,
                                    PixelMemLayout::ID pfId, float rangeMax) {
        PixelFormat::Data d;
        d.id              = id;
        d.name            = name;
...
static PixelFormat::Data makeMonoDesc(PixelFormat::ID id, const char *name, const char *desc,
                                    PixelMemLayout::ID pfId, ColorModel::ID colorModelId, float rangeMax) {
        PixelFormat::Data d;
        d.id              = id;
        d.name            = name;
        d.desc            = desc;
...
static PixelFormat::Data makeYUV8_420_Planar() {
        auto d = makeYCbCrDesc(PixelFormat::YUV8_420_Planar_Rec709,
                "YUV8_420_Planar_Rec709", "8-bit YCbCr 4:2:0 planar, Rec.709, limited range",
                PixelMemLayout::P_420_3x8, ycbcrSem8);
        d.fourccList = { "I420" };
        return d;
}

static PixelFormat::Data makeYUV10_420_Planar_LE() {
        return makeYCbCrDesc(PixelFormat::YUV10_420_Planar_LE_Rec709,
...
static PixelFormat::Data makeYUV10_420_Planar_BE() {
        return makeYCbCrDesc(PixelFormat::YUV10_420_Planar_BE_Rec709,
                "YUV10_420_Planar_BE_Rec709", "10-bit YCbCr 4:2:0 planar BE, Rec.709, limited range",
                PixelMemLayout::P_420_3x10_BE, ycbcrSem10);
}

static PixelFormat::Data makeYUV12_420_Planar_LE() {
        return makeYCbCrDesc(PixelFormat::YUV12_420_Planar_LE_Rec709,
...
static PixelFormat::Data makeYUV12_420_Planar_BE() {
        return makeYCbCrDesc(PixelFormat::YUV12_420_Planar_BE_Rec709,
                "YUV12_420_Planar_BE_Rec709", "12-bit YCbCr 4:2:0 planar BE, Rec.709, limited range",
                PixelMemLayout::P_420_3x12_BE, ycbcrSem12);
}
...
static PixelFormat::Data makeYUV8_420_SemiPlanar() {
        auto d = makeYCbCrDesc(PixelFormat::YUV8_420_SemiPlanar_Rec709,
                "YUV8_420_SemiPlanar_Rec709", "8-bit YCbCr 4:2:0 NV12, Rec.709, limited range",
                PixelMemLayout::SP_420_8, ycbcrSem8);
        d.fourccList = { "NV12" };
        return d;
}

static PixelFormat::Data makeYUV10_420_SemiPlanar_LE() {
        return makeYCbCrDesc(PixelFormat::YUV10_420_SemiPlanar_LE_Rec709,
...
static PixelFormat::Data makeRGBDesc(PixelFormat::ID id, const char *name, const char *desc,
                                   PixelMemLayout::ID pfId, bool alpha, float rangeMax) {
        PixelFormat::Data d;
        d.id              = id;
        d.name            = name;
...
static PixelFormat::Data makeYUV10_DPX() {
        return makeYCbCrDesc(PixelFormat::YUV10_DPX_Rec709,
                "YUV10_DPX_Rec709", "10-bit YCbCr 4:4:4 DPX packed, Rec.709, limited range",
                PixelMemLayout::I_3x10_DPX, ycbcrSem10);
}
...
static PixelFormat::Data makeYUV10_DPX_B() {
        return makeYCbCrDesc(PixelFormat::YUV10_DPX_B_Rec709,
...
static PixelFormat::Data makeMono8_sRGB() {
        return makeMonoDesc(PixelFormat::Mono8_sRGB,
                "Mono8_sRGB", "8-bit grayscale, sRGB",
                PixelMemLayout::I_1x8, ColorModel::sRGB, 255);
}

static PixelFormat::Data makeMono10_LE_sRGB() {
        return makeMonoDesc(PixelFormat::Mono10_LE_sRGB,
...
static PixelFormat::Data makeMono10_BE_sRGB() {
        return makeMonoDesc(PixelFormat::Mono10_BE_sRGB,
...
static PixelFormat::Data makeMono12_LE_sRGB() {
        return makeMonoDesc(PixelFormat::Mono12_LE_sRGB,
...
static PixelFormat::Data makeMono12_BE_sRGB() {
        return makeMonoDesc(PixelFormat::Mono12_BE_sRGB,
...
static PixelFormat::Data makeMono16_LE_sRGB() {
        return makeMonoDesc(PixelFormat::Mono16_LE_sRGB,
...
static PixelFormat::Data makeMono16_BE_sRGB() {
        return makeMonoDesc(PixelFormat::Mono16_BE_sRGB,
...
static PixelFormat::Data makeRGBAF16_LE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBAF16_LE_LinearRec709,
                "RGBAF16_LE_LinearRec709", "Half-float RGBA LE, linear Rec.709",
                PixelMemLayout::I_4xF16_LE, true, ColorModel::LinearRec709);
}

static PixelFormat::Data makeRGBAF16_BE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBAF16_BE_LinearRec709,
                "RGBAF16_BE_LinearRec709", "Half-float RGBA BE, linear Rec.709",
                PixelMemLayout::I_4xF16_BE, true, ColorModel::LinearRec709);
}

static PixelFormat::Data makeRGBF16_LE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBF16_LE_LinearRec709,
                "RGBF16_LE_LinearRec709", "Half-float RGB LE, linear Rec.709",
                PixelMemLayout::I_3xF16_LE, false, ColorModel::LinearRec709);
}

static PixelFormat::Data makeRGBF16_BE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBF16_BE_LinearRec709,
                "RGBF16_BE_LinearRec709", "Half-float RGB BE, linear Rec.709",
                PixelMemLayout::I_3xF16_BE, false, ColorModel::LinearRec709);
}

static PixelFormat::Data makeMonoF16_LE_LinearRec709() {
        return makeMonoDesc(PixelFormat::MonoF16_LE_LinearRec709,
                "MonoF16_LE_LinearRec709", "Half-float mono LE, linear Rec.709",
                PixelMemLayout::I_1xF16_LE, ColorModel::LinearRec709, 1.0);
}

static PixelFormat::Data makeMonoF16_BE_LinearRec709() {
        return makeMonoDesc(PixelFormat::MonoF16_BE_LinearRec709,
                "MonoF16_BE_LinearRec709", "Half-float mono BE, linear Rec.709",
                PixelMemLayout::I_1xF16_BE, ColorModel::LinearRec709, 1.0);
}

static PixelFormat::Data makeRGBAF32_LE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBAF32_LE_LinearRec709,
                "RGBAF32_LE_LinearRec709", "Float RGBA LE, linear Rec.709",
                PixelMemLayout::I_4xF32_LE, true, ColorModel::LinearRec709);
}

static PixelFormat::Data makeRGBAF32_BE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBAF32_BE_LinearRec709,
                "RGBAF32_BE_LinearRec709", "Float RGBA BE, linear Rec.709",
                PixelMemLayout::I_4xF32_BE, true, ColorModel::LinearRec709);
}

static PixelFormat::Data makeRGBF32_LE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBF32_LE_LinearRec709,
                "RGBF32_LE_LinearRec709", "Float RGB LE, linear Rec.709",
                PixelMemLayout::I_3xF32_LE, false, ColorModel::LinearRec709);
}

static PixelFormat::Data makeRGBF32_BE_LinearRec709() {
        return makeFloatRGBDesc(PixelFormat::RGBF32_BE_LinearRec709,
                "RGBF32_BE_LinearRec709", "Float RGB BE, linear Rec.709",
                PixelMemLayout::I_3xF32_BE, false, ColorModel::LinearRec709);
}

static PixelFormat::Data makeMonoF32_LE_LinearRec709() {
        return makeMonoDesc(PixelFormat::MonoF32_LE_LinearRec709,
                "MonoF32_LE_LinearRec709", "Float mono LE, linear Rec.709",
                PixelMemLayout::I_1xF32_LE, ColorModel::LinearRec709, 1.0);
}

static PixelFormat::Data makeMonoF32_BE_LinearRec709() {
        return makeMonoDesc(PixelFormat::MonoF32_BE_LinearRec709,
                "MonoF32_BE_LinearRec709", "Float mono BE, linear Rec.709",
                PixelMemLayout::I_1xF32_BE, ColorModel::LinearRec709, 1.0);
}
...
static PixelFormat::Data makeYUV8_444() {
        return makeYCbCrDesc(PixelFormat::YUV8_Rec709,
...
static PixelFormat::Data makeYUV10_422_UYVY_LE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV10_422_UYVY_LE_Rec2020,
...
static PixelFormat::Data makeYUV10_422_UYVY_BE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV10_422_UYVY_BE_Rec2020,
...
static PixelFormat::Data makeYUV12_422_UYVY_LE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV12_422_UYVY_LE_Rec2020,
...
static PixelFormat::Data makeYUV12_422_UYVY_BE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV12_422_UYVY_BE_Rec2020,
...
static PixelFormat::Data makeYUV10_420_Planar_LE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV10_420_Planar_LE_Rec2020,
...
static PixelFormat::Data makeYUV10_420_Planar_BE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV10_420_Planar_BE_Rec2020,
...
static PixelFormat::Data makeYUV12_420_Planar_LE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV12_420_Planar_LE_Rec2020,
...
static PixelFormat::Data makeYUV12_420_Planar_BE_Rec2020() {
        return makeYCbCrDescWithModel(PixelFormat::YUV12_420_Planar_BE_Rec2020,
...
static PixelFormat::Data makeYUV8_422_Rec601() {
        auto d = makeYCbCrDescWithModel(PixelFormat::YUV8_422_Rec601,
                "YUV8_422_Rec601", "8-bit YCbCr 4:2:2, Rec.601, limited range",
                PixelMemLayout::I_422_3x8, ycbcrSem8, ColorModel::YCbCr_Rec601);
        d.fourccList = { "YUY2", "YUYV" };
        return d;
}

static PixelFormat::Data makeYUV8_422_UYVY_Rec601() {
        auto d = makeYCbCrDescWithModel(PixelFormat::YUV8_422_UYVY_Rec601,
...
static PixelFormat::Data makeYUV8_420_Planar_Rec601() {
        auto d = makeYCbCrDescWithModel(PixelFormat::YUV8_420_Planar_Rec601,
                "YUV8_420_Planar_Rec601", "8-bit YCbCr 4:2:0 planar, Rec.601, limited range",
                PixelMemLayout::P_420_3x8, ycbcrSem8, ColorModel::YCbCr_Rec601);
        d.fourccList = { "I420" };
        return d;
}

static PixelFormat::Data makeYUV8_420_SemiPlanar_Rec601() {
        auto d = makeYCbCrDescWithModel(PixelFormat::YUV8_420_SemiPlanar_Rec601,
                "YUV8_420_SemiPlanar_Rec601", "8-bit YCbCr 4:2:0 NV12, Rec.601, limited range",
                PixelMemLayout::SP_420_8, ycbcrSem8, ColorModel::YCbCr_Rec601);
        d.fourccList = { "NV12" };
        return d;
}
...
static PixelFormat::Data makeYUV8_411_Planar() {
        return makeYCbCrDesc(PixelFormat::YUV8_411_Planar_Rec709,
                "YUV8_411_Planar_Rec709", "8-bit YCbCr 4:1:1 planar, Rec.709, limited range",
                PixelMemLayout::P_411_3x8, ycbcrSem8);
}
...
static PixelFormat::Data makeYUV8_444_Planar() {
        return makeYCbCrDesc(PixelFormat::YUV8_444_Planar_Rec709,
                "YUV8_444_Planar_Rec709", "8-bit YCbCr 4:4:4 planar, Rec.709, limited range",
                PixelMemLayout::P_444_3x8, ycbcrSem8);
}

static PixelFormat::Data makeYUV10_444_Planar_LE() {
        return makeYCbCrDesc(PixelFormat::YUV10_444_Planar_LE_Rec709,
                "YUV10_444_Planar_LE_Rec709", "10-bit YCbCr 4:4:4 planar LE, Rec.709, limited range",
                PixelMemLayout::P_444_3x10_LE, ycbcrSem10);
}

static PixelFormat::Data makeProRes422Desc(PixelFormat::ID id, const char *name, const char *desc,
...
size_t PixelFormat::planeSize(size_t planeIndex, const ImageDesc &desc) const {
        ...
        return d->memLayout.planeSize(planeIndex, desc.width(), desc.height(),
