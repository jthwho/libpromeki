...
Dir Dir::temp() {
        ...
        const String override = LibraryOptions::instance().getAs<String>(LibraryOptions::TempDir, String());
        if (!override.isEmpty()) {
...
Dir Dir::ipc() {
        ...
        const String override = LibraryOptions::instance().getAs<String>(LibraryOptions::IpcDir, String());
        if (!override.isEmpty()) {
                return Dir(FilePath(override));
        }
