...
static VideoCodec::Data makeProRes(VideoCodec::ID id, const char *name, const char *desc, FourCC fourcc,
                                   PixelFormat::ID compressedPd, bool alpha, int bitDepth) {
        VideoCodec::Data d;
        d.id = id;
        d.name = name;
        d.desc = desc;
...
struct VideoCodecRegistry {
                ...
                VideoCodecRegistry() {
                        ...
                        add(makeJPEG());
                        add(makeJPEG_XS());
                        add(makeProRes(VideoCodec::ProRes_422_Proxy, "ProRes_422_Proxy", "Apple ProRes 422 Proxy",
                                       FourCC("apco"), PixelFormat::ProRes_422_Proxy, /*alpha=*/false, /*bd=*/10));
                        add(makeProRes(VideoCodec::ProRes_422_LT, "ProRes_422_LT", "Apple ProRes 422 LT",
                                       FourCC("apcs"), PixelFormat::ProRes_422_LT, false, 10));
                        add(makeProRes(VideoCodec::ProRes_422, "ProRes_422", "Apple ProRes 422", FourCC("apcn"),
                                       PixelFormat::ProRes_422, false, 10));
                        add(makeProRes(VideoCodec::ProRes_422_HQ, "ProRes_422_HQ", "Apple ProRes 422 HQ",
                                       FourCC("apch"), PixelFormat::ProRes_422_HQ, false, 10));
                        add(makeProRes(VideoCodec::ProRes_4444, "ProRes_4444", "Apple ProRes 4444", FourCC("ap4h"),
                                       PixelFormat::ProRes_4444, true, 12));
                        add(makeProRes(VideoCodec::ProRes_4444_XQ, "ProRes_4444_XQ", "Apple ProRes 4444 XQ",
                                       FourCC("ap4x"), PixelFormat::ProRes_4444_XQ, true, 12));
                }
