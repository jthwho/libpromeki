...
FrameCount &FrameCount::operator+=(const FrameCount &other) {
        if(isUnknown() || other.isUnknown()) { _value = UnknownValue; return *this; }
        if(isInfinite() || other.isInfinite()) { _value = InfinityValue; return *this; }
...
FrameCount &FrameCount::operator-=(const FrameCount &other) {
        if(isUnknown() || other.isUnknown()) { _value = UnknownValue; return *this; }
        if(isInfinite() && other.isInfinite()) { _value = UnknownValue; return *this; }
        if(isInfinite())       { _value = InfinityValue; return *this; }  // ∞ - finite = ∞
        if(other.isInfinite()) { _value = UnknownValue;  return *this; }  // finite - ∞ = Unknown
        int64_t nv = _value - other._value;
        _value = nv < 0 ? UnknownValue : nv;
        return *this;
}
