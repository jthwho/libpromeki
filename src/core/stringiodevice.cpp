...
StringIODevice::StringIODevice(String *string, ObjectBase *parent) : IODevice(parent), _string(string) {}

StringIODevice::StringIODevice(ObjectBase *parent) : IODevice(parent) {}
