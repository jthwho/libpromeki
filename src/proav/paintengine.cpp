...
bool PaintEngine::Impl::blit(const Point2Di32 &destTopLeft, const UncompressedVideoPayload &src,
...
size_t PaintEngine::Impl::compositePoints(const Pixel &pixel, const Point2Di32 *points, const float *alphas,
