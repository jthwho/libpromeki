...
template <typename CompType, int BitsPerComp, bool IsUYVY>
class PaintEngine_422 : public PaintEngine::Impl {
        ...
        public:
                ...
                size_t compositePoints(const PaintEngine::Pixel &pixel,
                        ...
                        for(size_t i = 0; i < count; i++) {
                                ...
                                CompType *yPtr = reinterpret_cast<CompType *>(
                                        macro + ((p.x() & 1) ? Y1_off : Y0_off));
