...
MediaIO::FormatDesc MediaIOTask_Inspector::formatDesc() {
        return {"Inspector",
                ...
                []() -> MediaIOTask * { return new MediaIOTask_Inspector(); },
...
Error MediaIOTask_Inspector::openCaptureStatsFile(const String &configured) {
        ...
        promekiInfo("MediaIOTask_Inspector: CaptureStats writing to %s", _statsFilePath.cstr());
...
void MediaIOTask_Inspector::runCaptureStats(const Frame &frame, const InspectorEvent &event) {
