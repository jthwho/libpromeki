...
namespace promeki {
        namespace csc {
                namespace HWY_NAMESPACE {
                        ...
                        void UnpackInterleavedImpl(const void *src, float *const *buffers, size_t width, int compCount,
                                ...
                                if (pixelsPerBlock == 1) {
                                        ...
                                        // failure mode).
                                        auto readSample = [](const uint8_t *base, int byteOffset, int bits) -> float {
                                                if (bits <= 8) {
                                        ...
                                        for (size_t b = 0; b < blockCount; b++) {
                                                ...
                                                for (int px = 0; px < pixelsPerBlock; px++) {
                                                        ...
                                                        buffers[1][x] =
                                                                readSample(block, compByteOffset[1], compBits[1]);
                                                        buffers[2][x] =
                                                                readSample(block, compByteOffset[2], compBits[2]);
                                                }
                                        }
                                }
                                return;
                        ...
                        void UnpackPlanarImpl(const void *const *planes, const size_t *strides, float *const *buffers,
                        ...
                        void UnpackSemiPlanarImpl(const void *const *planes, const size_t *strides,
                                                  float *const *buffers, size_t width, int bitsPerComp,
                                                  const int *planeHSub, const int *planeBytesPerSample, bool hasAlpha,
                                                  int alphaCompIndex, const int *compByteOffset, bool useSimd) {
