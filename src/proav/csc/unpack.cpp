...
namespace promeki {
        namespace csc {
                ...
                void unpackInterleaved(const void *src, float *const *buffers, size_t width, int compCount,
                        ...
                        HWY_DYNAMIC_DISPATCH(UnpackInterleavedImpl)(src, buffers, width, compCount, bitsPerComp,
                ...
                void unpackPlanar(const void *const *planes, const size_t *strides, float *const *buffers, size_t width,
                        ...
                        HWY_DYNAMIC_DISPATCH(UnpackPlanarImpl)(planes, strides, buffers, width, compCount, bitsPerComp,
                ...
                void unpackSemiPlanar(const void *const *planes, const size_t *strides, float *const *buffers,
                        ...
                        HWY_DYNAMIC_DISPATCH(UnpackSemiPlanarImpl)(planes, strides, buffers, width, bitsPerComp,
