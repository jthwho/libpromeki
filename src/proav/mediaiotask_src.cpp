...
Error MediaIOTask_SRC::proposeInput(const MediaDesc &offered, MediaDesc *preferred) const {
...
Error MediaIOTask_SRC::proposeOutput(const MediaDesc &requested, MediaDesc *achievable) const {
