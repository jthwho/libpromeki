...
void sortByWeight(List<AudioEncoder::BackendRecord> &list) {
        std::sort(list.begin(), list.end(),
                  [](const AudioEncoder::BackendRecord &a,
                     const AudioEncoder::BackendRecord &b) {
...
List<int> AudioEncoder::supportedInputsFor(AudioCodec::ID codecId,
...
Result<AudioEncoder *> AudioEncoder::create(AudioCodec::ID codecId,
                                             AudioCodec::Backend pinned,
