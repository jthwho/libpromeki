...
Error MediaIOTask_DebugMedia::proposeInput(const MediaDesc &offered, MediaDesc *preferred) const {
        if (preferred == nullptr) return Error::Invalid;
        *preferred = offered;
        return Error::Ok;
}

Error MediaIOTask_DebugMedia::proposeOutput(const MediaDesc &requested, MediaDesc *achievable) const {
