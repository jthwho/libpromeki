...
MacAddress MacAddress::fromIpv4Multicast(const Ipv4Address &addr) {
        ...
        return MacAddress(0x01, 0x00, 0x5E, static_cast<uint8_t>(addr.octet(1) & 0x7F), addr.octet(2), addr.octet(3));
}
...
MacAddress MacAddress::fromIpv6Multicast(const Ipv6Address &addr) {
        ...
        return MacAddress(0x33, 0x33, raw[12], raw[13], raw[14], raw[15]);
}
