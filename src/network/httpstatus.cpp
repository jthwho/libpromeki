...
String HttpStatus::reasonPhrase() const {
        // Canonical reason phrases per RFC 9110.  Kept inline rather
        // than reading via valueName() because the wire form
        ...
        return String::sprintf("Status %d", value());
}
