 ...
 */
        bool splitKeyValue(const promeki::String &arg, promeki::String &key, promeki::String &val);
 ...
 */
        promeki::Error applyStageConfig(StageSpec &stage, const promeki::String &stageLabel);
 ...
 */
        promeki::Error applyStageMetadata(StageSpec &stage, const promeki::String &stageLabel);
 ...
 */
        promeki::MediaIO *buildFileSink(const StageSpec &spec, const promeki::MediaDesc &srcDesc,
                                        const promeki::AudioDesc &srcAudioDesc, const promeki::Metadata &srcMetadata,
